...
namespace OfficeAgent.ExcelAddIn.Tests
{
    ...
    {
        [Fact]
        public void RenderPlacesTemplateBindingsAfterBindingsAndFieldMappingsUsingReadableSections()
        {
            ...
            Assert.Equal("TemplateBindings", rendered[10][0]);
            Assert.Equal(new[] { "SheetName", "TemplateId", "TemplateName" }, rendered[11]);
            Assert.Equal(new[] { "Sheet1", "tmpl-001", "Quarterly Report" }, rendered[12]);
        }
